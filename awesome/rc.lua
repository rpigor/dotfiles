...
local layout_name = {}
layout_name.tile = "[t]"
layout_name.tileleft = "[l]"
layout_name.tilebottom = "[b]"
layout_name.tiletop = "[tt]"
layout_name.fairv = "[fv]"
layout_name.fairh = "[fh]"
layout_name.spiral = "[s]"
layout_name.dwindle = "[d]"
layout_name.max = "[m]"
layout_name.fullscreen = "[F]"
layout_name.magnifier = "[M]"
...
local volume_widget_inst = volume_widget({ widget_type = "icon_and_text" })
...
local function update_txt_layoutbox(s)
	...
	local txt_l = layout_name[awful.layout.getname(awful.layout.get(s))] or ""
...
awful.screen.connect_for_each_screen(function(s)
	...
	local names = { "main", "www", "social", "other" }
	local l = awful.layout.suit -- Just to save some typing: use an alias.
	local layouts = { l.spiral, l.max, l.max, l.floating }
	...
	-- Textual layoutbox
	s.mytxtlayoutbox = wibox.widget.textbox(layout_name[awful.layout.getname(awful.layout.get(s))])
...
awful.rules.rules = {
	...
	{
		rule = { class = "discord" },
		properties = { screen = 1, tag = "social", maximized = true, titlebars_enabled = false },
	},
}
-- }}}
